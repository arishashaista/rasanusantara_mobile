...
class MenuService {
  ...
  static const String baseUrl = 'http://127.0.0.1:8000/adminview/api/menu_items';
  ...
  static Future<void> addMenuItem(
    ...
    print('Request body: ${jsonEncode({'name': name, 'categories': categories})}');
  ...
  static Future<void> editMenuItem(
      String restaurantId, String menuItemId, String name, List<String> categories) async {
